...
def desenhar_icone_missoes(screen, x, y):
    ...
    pygame.draw.circle(screen, (0,0,0), (x+22, y+22), 20) # Sombra
    pygame.draw.circle(screen, (255, 215, 0), (x+20, y+20), 20) # Ouro
...
def desenhar_popup_loja(screen, largura, altura, imperio):
    ...
    nome1 = "Auto Clicker (Comprado)" if tem_auto else "Auto Clicker (25 Moedas)"
